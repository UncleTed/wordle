(this.wordle = this.wordle || {}),
  (this.wordle.bundle = function (e) {
    ...
    // {
    //    width: 100%   display: inline-flex   justify-content: center   align-items: center   font-size: 2rem   line-height: 2rem   font-weight: bold   vertical-align: middle   box-sizing: border-box   color: var(--tile-text-color)   text-transform: uppercase   user-select: none }

    //  .tile::before

    // {
    //    content: ''   display: inline-block   padding-bottom: 100% }

    //   /* Allow tiles to be smaller on small screens */  @media (max-height: 600px)
    ...
    // {
    //    background-color: var(--color-tone-7)   border: 2px solid var(--color-tone-3)   color: var(--color-tone-1) }
    ...
    // {
    //    animation-name: PopIn   animation-duration: 100ms }
    ...
    // {
    //     animation-name: FlipIn   animation-duration: 250ms   animation-timing-function: ease-in }
    ...
    // {
    //     animation-name: FlipOut   animation-duration: 250ms   animation-timing-function: ease-in }
    ...
    // </style><div class=\"tile\" data-state=\"empty\" data-animation=\"idle\"></div>\n";
    var w = (function (e) {
      i(n, e);
      var t = f(n);
      function n() {
    ...
    // {
    //       animation-name: Shake     animation-duration: 600ms   }
    ...
    // {
    //       animation-name: Bounce     animation-duration: 1000ms   }
    ...
    var G,
      ...
      Y = (G = /[^.]+$/.exec((W && W.keys && W.keys.IE_PROTO) || ""))
        ? "Symbol(src)_1." + G
        : "";
          ...
          (d = l),
            h || m || f
              ...
              : (function (e) {
                  ...
                  return (
                    "function" == typeof n && n instanceof n && We.call(n) == Ve
                  );
                })(l) || Me(l)
              ? ((d = i),
                Me(i)
          ...
          if (en) {
            ...
            if (
              (["protocol", "publicKey", "host", "projectId"].forEach(function (
                ...
                if (!e[t])
                  throw new Qt("Invalid Sentry Dsn: " + t + " missing");
              }),
              !n.match(/^\d+$/))
            )
              throw new Qt("Invalid Sentry Dsn: Invalid projectId " + n);
            if (
              !(function (e) {
                return "http" === e || "https" === e;
              })(a)
            )
              throw new Qt("Invalid Sentry Dsn: Invalid protocol " + a);
            if (t && isNaN(parseInt(t, 10)))
              throw new Qt("Invalid Sentry Dsn: Invalid port " + t);
          }
        })(t),
        t
      );
    ...
    function wn(e) {
      try {
        return (
          (t = e),
          "undefined" != typeof Element && Jt(t, Element)
            ? Xt(e)
    ...
    function Sn(e) {
      ...
      if (Gt(e)) {
        ...
        try {
          for (
            var s = It(Object.keys(e)), r = s.next();
            !r.done;
            r = s.next()
          ) {
            var o = r.value;
      ...
      if (!qn[e])
        switch (((qn[e] = !0), e)) {
              ...
              Ln.document.addEventListener("click", t, !1),
                ...
                ["EventTarget", "Node"].forEach(function (t) {
                  ...
                  n &&
                    ...
                    (yn(n, "addEventListener", function (t) {
                ...
                return function () {
                  ...
                  return (
                    ...
                    "function" == typeof a.onreadystatechange
                      ? yn(a, "onreadystatechange", function (e) {
                          return function () {
                            for (var t = [], n = 0; n < arguments.length; n++)
                              t[n] = arguments[n];
          ...
          case "history":
            !(function () {
              ...
              (Ln.onpopstate = function () {
                ...
                yn(Ln.history, "pushState", t),
                yn(Ln.history, "replaceState", t);
            })();
            break;
          case "error":
            (Un = Ln.onerror),
              (Ln.onerror = function (e, t, n, a, s) {
                return (
                  Nn(
                    "error",
          ...
          case "unhandledrejection":
            ($n = Ln.onunhandledrejection),
              (Ln.onunhandledrejection = function (e) {
                return (
                  Nn("unhandledrejection", e), !$n || $n.apply(this, arguments)
                );
              });
            break;
          default:
    ...
    function Pn(e) {
      return (
        void 0 === e && (e = []),
        "Request" in Ln && Jt(e[0], Request) && e[0].method
    ...
    function ea(e, t, a, s, r) {
      ...
      if (
        null === t ||
        (["number", "boolean", "string"].includes(n(t)) && !Vt(t))
      )
        return t;
      var p = (function (e, t) {
        try {
      ...
      return {
        ...
        add: function (a) {
          if (!(void 0 === e || t.length < e))
            return na(
              new Qt("Not adding Promise due to buffer limit reached.")
            );
          var s = a();
          return (
    ...
    function ba(e, t, n) {
      ...
      if (l)
        try {
          for (
            var u = It(l.trim().split(",")), d = u.next();
            !d.done;
            d = u.next()
          ) {
            ...
            if (p[1])
              try {
                for (
                  var f = ((r = void 0), It(p[1].split(";"))), y = f.next();
                  !y.done;
                  y = f.next()
                ) {
                  i[y.value] = n + m;
      ...
      return (
        ...
        (e.prototype.applyToEvent = function (e, t) {
          ...
          return (
            ...
            this._notifyEventProcessors(Rt(wa(), this._eventProcessors), e, t)
          );
        }),
        ...
        return (
          (e.prototype.update = function (e) {
            if (
              ...
              (this.timestamp = e.timestamp || da()),
              e.ignoreDuration && (this.ignoreDuration = e.ignoreDuration),
              e.sid && (this.sid = 32 === e.sid.length ? e.sid : Gn()),
    ...
    function Ta() {
      var e = ja();
      return (
        (Ca(e) && !Oa(e).isOlderThan(4)) || Ia(e, new za()),
        qt()
          ? (function (e) {
              try {
                var t = ja().__SENTRY__,
    ...
    function Aa(e, t, n) {
      return { initDsn: e, metadata: t || {}, dsn: sn(e), tunnel: n };
    }
          ...
          (t[e.name] = e),
            (function (e) {
              -1 === Fa.indexOf(e.name) &&
                (e.setupOnce(_a, Ta),
                Fa.push(e.name),
                Ba && rn.log("Integration installed: " + e.name));
            })(e);
        }),
        gn(t, "initialized", !0),
        t
        ...
        return (
          ...
          (e.prototype.setupIntegrations = function () {
            this._isEnabled() &&
              ...
              (this._integrations = $a(this._options));
          }),
          (e.prototype.getIntegration = function (e) {
            try {
          ...
          (e.prototype._applyClientOptions = function (e) {
            ...
            "environment" in e ||
              ...
              e.message && (e.message = hn(e.message, o));
          ...
          (e.prototype._processEvent = function (e, t, n) {
            ...
            if (!this._isEnabled())
              return na(new Qt("SDK not enabled, will not capture event."));
    ...
    var Xa = (function () {
      ...
      Ka = (function () {
        function e(e) {
          (this._options = e),
            this._options.dsn ||
              (Ba && rn.warn("No DSN provided, backend will not do anything.")),
                          ...
                          if (e.exception)
                            try {
                              ...
                              return (
                                Ba &&
                                  rn.error(
                                    "Cannot extract message for event " + Vn(e)
                                  ),
                                []
                              );
                            }
    ...
    var cs =
      ...
      ms = [
        ...
        function (e) {
          ...
          if (n) {
            ...
            return (
              (r = (t = Lt(ws(r, s), 2))[0]),
              ls((s = t[1]), r, n[4] ? +n[4] : void 0, n[5] ? +n[5] : void 0)
            );
          }
        },
      ],
      ...
      ys = [
        ...
        function (e) {
          var t = fs.exec(e);
          return t
            ? ls(t[2], t[1] || is, +t[3], t[4] ? +t[4] : void 0)
            : void 0;
        },
      ],
      ...
      As = (function () {
        function e(e) {
          ...
          (this.options = e),
            ...
            (this.url = Da(this._api.dsn)),
            this.options.sendClientReports &&
              qs.document &&
              qs.document.addEventListener("visibilitychange", function () {
        ...
        return (
            ...
            return this._sendRequest(
              (function (e, t) {
                var n = Lt(Ja(e, t), 2),
                  a = n[0],
                  s = n[1];
                return { body: ya(a), type: s, url: Ha(t.dsn, t.tunnel) };
              })(e, this._api),
              e
            );
          }),
          ...
          (e.prototype._flushOutcomes = function () {
            if (this.options.sendClientReports) {
              ...
              if (((this._outcomes = {}), Object.keys(e).length)) {
                Os &&
                  rn.log("Flushing outcomes:\n" + JSON.stringify(e, null, 2));
                var t,
                  n,
                  a,
                  s = Ha(this._api.dsn, this._api.tunnel),
                  r = Object.keys(e).map(function (t) {
                    var n = Lt(t.split(":"), 2),
                      a = n[0];
                    return { reason: n[1], category: a, quantity: e[t] };
                  }),
                  o =
                    ((t = r),
                    fa(
                      (n = this._api.tunnel && nn(this._api.dsn))
                        ? {
                            dsn: n,
                          }
                        : {},
          ...
          (e.prototype._handleResponse = function (e) {
            var t = e.requestType,
              ...
              r = e.reject,
              o = oa(n.status);
            (this._rateLimits = ba(this._rateLimits, a)),
          ...
          throw (
            ...
            qa(function (n) {
              n.addEventProcessor(function (e) {
                return (
                  t.mechanism && (Jn(e, void 0, void 0), Xn(e, t.mechanism)),
                  (e.extra = Ot(
                    Ot(
                      {},
        ...
        (e.prototype.setupOnce = function () {
          ...
          for (var n in t) {
            ...
            a &&
              t[n] &&
              ((e = n),
              Os && rn.log("Global Handler attached: " + e),
              a(),
    ...
    var Ks = [
      ...
      Zs = (function () {
        ...
        return (
          (e.prototype.setupOnce = function () {
            var e = Mt();
            this._options.setTimeout && yn(e, "setTimeout", Qs),
              this._options.setInterval && yn(e, "setInterval", Qs),
              this._options.requestAnimationFrame &&
                yn(e, "requestAnimationFrame", er),
              this._options.XMLHttpRequest &&
                "XMLHttpRequest" in e &&
                yn(XMLHttpRequest.prototype, "send", tr);
    ...
    var ar = (function () {
      ...
      return (
        ...
        (e.prototype.setupOnce = function () {
          this._options.console && Mn("console", sr),
            this._options.dom &&
              Mn(
                "dom",
                (function (e) {
            ...
            this._options.xhr && Mn("xhr", rr),
            this._options.fetch && Mn("fetch", or),
            this._options.history && Mn("history", ir);
        }),
        (e.id = "Breadcrumbs"),
        e
      );
    ...
    function sr(e) {
      ...
      if ("assert" === e.level) {
        ...
        (t.message =
          "Assertion failed: " +
          (mn(e.args.slice(1), " ") || "console.assert")),
    ...
    function cr(e, t, n, a) {
      if ((void 0 === a && (a = []), !Jt(t[n], Error) || a.length + 1 >= e))
        return a;
      var s = _s(t[n]);
    ...
    function br(e) {
      if (
        (void 0 === e && (e = {}),
        void 0 === e.defaultIntegrations && (e.defaultIntegrations = vr),
        void 0 === e.release)
      ) {
        var t = Mt();
        t.SENTRY_RELEASE &&
    ...
    var Tr = (function (e) {
        ...
        return (
          ...
          (t.prototype.initSpanRecorder = function (e) {
            void 0 === e && (e = 1e3),
              this.spanRecorder || (this.spanRecorder = new Er(e)),
              this.spanRecorder.add(this);
          }),
          (t.prototype.setMeasurements = function (e) {
            this._measurements = Ot(
              {},
        ...
        (function () {
          function e(e) {
            if (
              ((this.traceId = Gn()),
              (this.spanId = Gn().substring(16)),
              (this.startTimestamp = pa()),
              (this.tags = {}),
              (this.data = {}),
              !e)
            )
        ...
        return (
          ...
          (t.prototype.add = function (t) {
            ...
            t.spanId !== this.transactionSpanId &&
              ((t.finish = function (e) {
                (t.endTimestamp = "number" == typeof e ? e : pa()),
        ...
        return (
          ...
          (t.prototype.finish = function (t) {
            ...
            if (
              ...
              try {
                for (
                  var r = It(this._beforeFinishCallbacks), o = r.next();
                  !o.done;
                  o = r.next()
                ) {
                  (0, o.value)(this, t);
            ...
            return (
              this._onScope && Ir(this._idleHub),
              e.prototype.finish.call(this, t)
            );
          }),
          ...
          (t.prototype._pushActivity = function (e) {
            this._initTimeout &&
              ...
              wr && rn.log("[Tracing] pushActivity: " + e),
              (this.activities[e] = !0),
              wr &&
                rn.log(
          ...
          (t.prototype._popActivity = function (e) {
            ...
            if (
              (this.activities[e] &&
                (wr && rn.log("[Tracing] popActivity " + e),
      ...
      return _r(t)
        ? void 0 !== e.sampled
          ...
          : ("function" == typeof t.tracesSampler
            ...
            (function (e) {
              if (Vt(e) || ("number" != typeof e && "boolean" != typeof e))
                return (
                  wr &&
                    rn.warn(
    ...
    var qr = function (e, t, n) {
      ...
      Nr = function (e, t) {
        var n = function n(a) {
          ("pagehide" !== a.type &&
            "hidden" !== Mt().document.visibilityState) ||
            (e(a),
            t &&
      ...
      Dr = function () {
        return (
          Pr < 0 &&
            ((Pr = "hidden" === Mt().document.visibilityState ? 0 : 1 / 0),
            Nr(
              function (e) {
                var t = e.timeStamp;
                Pr = t;
        ...
        function e(e) {
          void 0 === e && (e = !1),
            ...
            !qt() &&
              ...
              Br.document &&
              (Br.performance.mark &&
                Br.performance.mark("sentry-tracing-init"),
              this._trackCLS(),
              this._trackLCP(),
              this._trackFID());
        }
        ...
        return (
          (e.prototype.addPerformanceEntries = function (e) {
            ...
            if (Br && Br.performance && Br.performance.getEntries && ha) {
              ...
              if (
                      ...
                      switch (r.entryType) {
                        case "navigation":
                          !(function (e, t, n) {
                            ...
                            (n = s + Sr(r.responseStart)),
                            (a = s + Sr(r.requestStart));
                          break;
                        case "mark":
                        case "paint":
                        case "measure":
                          ...
                          "first-paint" === r.name &&
                            u &&
                            (wr && rn.log("[Measurements] Adding FP"),
                            (t._measurements.fp = {
                              value: r.startTime,
                            }),
                            ...
                            "first-contentful-paint" === r.name &&
                              u &&
                              (wr && rn.log("[Measurements] Adding FCP"),
                              (t._measurements.fcp = {
                                value: r.startTime,
                              }),
                ...
                var r = Sr(ha);
                "number" == typeof n &&
                  (wr && rn.log("[Measurements] Adding TTFB"),
                    ...
                    $r(
...

                      {
                        ...
                        endTimestamp:
                          ...
                          Sr(this._measurements.fid.value),
                        op: "web.vitals",
                  ...
                  (function (e, t, n) {
                    t &&
                      (wr && rn.log("[Measurements] Adding LCP Data"),
                      t.element && e.setTag("lcp.element", Xt(t.element)),
                      t.id && e.setTag("lcp.id", t.id),
                      t.url && e.setTag("lcp.url", t.url.trim().slice(0, 200)),
                      e.setTag("lcp.size", t.size));
                    n &&
                      n.sources &&
                      (wr && rn.log("[Measurements] Adding CLS Data"),
          ...
          (e.prototype._trackCLS = function () {
            ...
            (e = function (e) {
              var t = e.entries.pop();
              t &&
                (wr && rn.log("[Measurements] Adding CLS"),
                (l._measurements.cls = {
                  value: e.value,
                }),
                (l._clsEntry = t));
            ...
            !(function (e, t) {
              ...
              function (t) {
                ...
                if (n) {
                  var a = Sr(ha),
                    s = Sr(n.startTime);
                  wr && rn.log("[Measurements] Adding LCP"),
                    (e._measurements.lcp = {
                      value: t.value,
                    }),
          ...
          (e.prototype._trackFID = function () {
            ...
            (e = function (e) {
              ...
              if (t) {
                var n = Sr(ha),
                  a = Sr(t.startTime);
                wr && rn.log("[Measurements] Adding FID"),
                  (i._measurements.fid = {
                    value: e.value,
                  }),
    ...
    var Zr = {
        ...
        integrations: [new Kr()],
        release:
          (null === (Jr = window.wordle) || void 0 === Jr ? void 0 : Jr.hash) ||
          "",
    ...
    // {
    // \n    display: flex   justify-content: space-between   align-items: center   border-bottom: 1px solid var(--color-tone-4)   padding: 16px 0 }
    ...
    // {
    // \n    font-size: 12px   color: var(--color-tone-2) }

    // \n\n  #footnote

    // {
    // \n    position: absolute   bottom: 0   left: 0   right: 0   padding: 16px   color: var(--color-tone-2)   font-size: 12px   text-align: right   display: flex   justify-content: space-between   align-items: flex-end }
    ...
    // void 0!==arguments[0]?arguments[0]:"Wordle Feedback",
    // n=(new Date).getTimezoneOffset(),a="\r\n\r\n\n--\nDevice summary:\nPage: /games/wordle\nPlatform: "
    //   .concat(so()?"Web (Mobile)":"Web (Desktop)"," \nBrowser: ")
    //   .concat(io(ro()),"\nScreen Resolution: ").concat(window.screen.width," x ").concat(window.screen.height,"\nViewport Size: ")
    //   .concat(document.documentElement.clientWidth," x ")
    //   .concat(document.documentElement.clientHeight,"\nTimezone: ","UTC".concat(n>0?"":"+")
    //   .concat(n/-60),"\nBuild: ")
    //   .concat(null===(e=window.wordle)||void 0===e?void 0:e.hash,"\n  ");

    // return oo+lo({subject:t,body:a})}
        ...
        r(n, [
          {
            ...
            value: function () {
              var e = this;
              this.shadowRoot.appendChild(co.content.cloneNode(!0)),
    ...
    // {
    // \n      position: relative     margin: 16px     background-color: var(--color-tone-1)     color: var(--color-tone-7)     padding: 16px     border: none     border-radius: 4px     opacity: 1     transition: opacity 300ms cubic-bezier(0.645, 0.045, 0.355, 1)     font-weight: 700   }

    // \n    .win

    // {
    // \n      background-color: var(--color-correct)     color: var(--tile-text-color)   }
    ...
    function Io(e) {
      ...
      t
        ...
        (s.averageGuesses = Math.round(
          Object.entries(s.guesses).reduce(
            function (e, t) {
              var n = y(t, 2),
                a = n[0],
                s = n[1];
    ...
    // {
    // \n    position: absolute   top: 10%   left: 50%   transform: translate(-50%, 0)   pointer-events: none   width: fit-content }
    ...
    // {
    // \n    width: 100%   max-width: var(--game-max-width)   margin: 0 auto   height: calc(100% - var(--header-height))   display: flex   flex-direction: column }

    // \n  header

    // {
    // \n    display: flex   flex-direction: row   align-items: center   justify-content: space-between   flex-wrap: nowrap   padding: 0 16px   height: var(--header-height)   color: var(--color-tone-1)   border-bottom: 1px solid var(--color-tone-4) }

    // \n  header .title

    // {
    // \n    font-family: \'nyt-karnakcondensed\'   font-weight: 700   font-size: 37px   line-height: 100%   letter-spacing: 0.01em   text-align: center   left: 0   right: 0   pointer-events: none }

    // \n  .menu-left

    // {
    // \n    display: flex   margin: 0   padding: 0   align-items: center   width: 70px   justify-content: flex-start }

    // \n  .menu-right

    // {
    // \n    display: flex   width: 70px   justify-content: flex-end }
    ...
    // {
    // \n      font-size: 22px     letter-spacing: 0.1rem   }
    ...
    // {
    // \n    display: flex   justify-content: center   align-items: center   flex-grow: 1   overflow: hidden }

    // \n  #board

    // {
    // \n    display: grid   grid-template-rows: repeat(6, 1fr)   grid-gap: 5px   padding:10px   box-sizing: border-box }
        ...
        return (
          ...
          !e.lastPlayedTs || xo(new Date(e.lastPlayedTs), e.today) >= 1
            ...
            : ((e.boardState = s.boardState),
              ...
              (e.dayOffset = zo(e.today)),
              (e.letterEvaluations = ko(e.boardState, e.evaluations)),
              (e.gameStatus = s.gameStatus),
              (e.lastCompletedTs = s.lastCompletedTs),
              (e.hardMode = s.hardMode),
              e.gameStatus !== Fo && (e.canInput = !1),
                ...
                if (this.hardMode) {
                  var a = (function (e, t, n) {
                      ...
                      for (var a = 0; a < n.length; a++)
                        if (n[a] === correct && e[a] !== t[a])
                          return {
                            validGuess: !1,
                            errorMessage: ""
                              .concat(wo(a + 1), " letter must be ")
                              .concat(t[a].toUpperCase()),
                          };
                      for (var s = {}, r = 0; r < n.length; r++)
                        [correct, present].includes(n[r]) &&
                          (s[t[r]] ? (s[t[r]] += 1) : (s[t[r]] = 1));
                      var o = e.split("").reduce(
                        function (e, t) {
                ...
                if (i || l)
                  Io({
                    ...
                    isStreak:
                      ...
                      1 === xo(new Date(this.lastCompletedTs), new Date()),
                    numGuesses: this.rowIndex,
                  }),
                    ao({
                      lastCompletedTs: Date.now(),
                    }),
                    (this.gameStatus = l ? Uo : $o),
                    qo.setItem(Ro, !0);
                (this.tileIndex = 0),
                  (this.canInput = !1),
                  ao({
...

          {
            ...
            value: function (e, t) {
              ...
              a.setAttribute("text", e),
                ...
                n
                  ? this.shadowRoot.querySelector("#system-toaster").prepend(a)
...

          {
            ...
            value: function () {
              var e,
                ...
                l,
                c = this;
              this.shadowRoot.appendChild(Ho.content.cloneNode(!0)),
                ...
                this.$game.addEventListener(
                  ...
                  function (e) {
                    ...
                    (e.path || (e.composedPath && e.composedPath())).includes(
                      ...
                      ([Uo, $o].includes(c.gameStatus) &&
                        (c.restoringFromLocalStorage
                          ? c.showStatsModal()
                          : (c.gameStatus === Uo &&
                              (t.setAttribute("win", ""),
                              c.addToast(Go[c.rowIndex - 1], 2e3)),
                            c.gameStatus === $o &&
          ...
          },
          {
            ...
            value: function () {
              ...
              this.shadowRoot
                ...
                .appendChild(Bo.content.cloneNode(!0)),
                this.shadowRoot
    ...
    // {
    // \n      display: none     position: absolute     width: 100%     height: 100%     top: 0     left: 0     justify-content: center     align-items: center     background-color: var(--opacity-50)     z-index: ".concat(3e3,'   }
    ...
    // {
    // \n      position: relative     border-radius: 8px     border: 1px solid var(--color-tone-6)     background-color: var(--modal-content-bg)     color: var(--color-tone-1)     box-shadow: 0 4px 23px 0 rgba(0, 0, 0, 0.2)     width: 90%     max-height: 90%     overflow-y: auto     animation: SlideIn 200ms     max-width: var(--game-max-width)     padding: 16px     box-sizing: border-box   }
    ...
    // {
    // \n      width: 24px     height: 24px     position: absolute     top: 16px     right: 16px   }

    // \n\n    game-icon

    // {
    // \n      position: fixed     user-select: none     cursor: pointer   }
    ...
    var Vo = (function (e) {
      ...
      function n() {
        ...
        return a(this, n), (e = t.call(this)).attachShadow({ mode: "open" }), e;
      }
    ...
    // {
    // \n    display: flex   width: 100%   margin: 0 auto 8px   /* https://stackoverflow.com/questions/46167604/ios-html-disable-double-tap-to-zoom */\n    touch-action: manipulation }

    // \n  \n  button

    // {
    // \n    font-family: inherit   font-weight: bold   border: 0   padding: 0   margin: 0 6px 0 0   height: 58px   border-radius: 4px   cursor: pointer   user-select: none   background-color: var(--key-bg)   color: var(--key-text-color)   flex: 1   display: flex   justify-content: center   align-items: center   text-transform: uppercase   -webkit-tap-highlight-color: rgba(0,0,0,0.3) }
    ...
    // {
    // \n    background-color: var(--key-bg-correct)   color: var(--key-evaluated-text-color) }

    // \n\n  button[data-state='present']

    // {
    // \n    background-color: var(--key-bg-present)   color: var(--key-evaluated-text-color) }

    // \n\n  button[data-state='absent']

    // {
    // \n    background-color: var(--key-bg-absent)   color: var(--key-evaluated-text-color) }
        ...
        return (
          r(n, [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                this.shadowRoot.appendChild(Jo.content.cloneNode(!0)),
...
------------------------------------------
customElements.define("game-keyboard",ri),function(){(console.warn||console.log).apply(console,arguments)}.bind("[clipboard-polyfill]");
...
var mi=(null===(ui=null==hi?void 0:hi.write)||void 0===ui||ui.bind(hi),null===(di=null==hi?void 0:hi.writeText)||void 0===di?void 0:di.bind(hi)),fi="undefined"==typeof window?void 0:window,yi=(null==fi||fi.ClipboardItem,fi);
    ...
    var ni,
      ...
      si,
      ri,
      oi = "undefined" == typeof navigator ? void 0 : navigator,
      ii = null == oi ? void 0 : oi.clipboard;
    null === (ni = null == ii ? void 0 : ii.read) ||
      void 0 === ni ||
      ni.bind(ii),
      null === (ai = null == ii ? void 0 : ii.readText) ||
        void 0 === ai ||
        ai.bind(ii);
    var li =
        (null === (si = null == ii ? void 0 : ii.write) ||
          void 0 === si ||
          si.bind(ii),
        null === (ri = null == ii ? void 0 : ii.writeText) || void 0 === ri
          ? void 0
          : ri.bind(ii)),
        ...
        return ti(this, function (n) {
          if (
            ...
            "undefined" == typeof ClipboardEvent &&
              void 0 !== ui.clipboardData &&
              void 0 !== ui.clipboardData.setData)
          ) {
            if (!t) throw new Error("No `text/plain` value was specified.");
            if (((a = e["text/plain"]), ui.clipboardData.setData("Text", a)))
              return [2, !0];
            throw new Error(
    ...
    // {
    // \n      display: flex     flex-direction: column     align-items: center     justify-content: center     padding-top: 16px   }

    // \n    h1

    // {
    // \n      font-weight: 700     font-size: 16px     letter-spacing: 0.5px     text-transform: uppercase     text-align: center     margin-bottom: 10px   }
    ...
    // {
    // \n      font-size: 36px     font-weight: 400     display: flex     align-items: center     justify-content: center     text-align: center     letter-spacing: 0.05em     font-variant-numeric: proportional-nums   }
    ...
    // {
    // \n      width: 100%     height: 20px     display: flex     align-items: center     padding-bottom: 4px     font-size: 14px     line-height: 20px   }

    // \n\n    .graph-container .graph

    // {
    // \n      width: 100%     height: 100%     padding-left: 4px   }

    // \n\n    .graph-container .graph .graph-bar

    // {
    // \n      height: 100%     /* Assume no wins */\n      width: 0%     position: relative     background-color: var(--color-absent)     display: flex     justify-content: center   }
    ...
    // {
    // \n      font-weight: bold     color: var(--tile-text-color)   }
    ...
    // {
    // \n      display: flex     width: 100%     align-items: center     justify-content: flex-start     text-decoration: none     padding-top: 16px   }

    // \n\n    .promo-text

    // {
    // \n      font-family: nyt-franklin     font-size: 14px     color: var(--color-tone-1)     flex-grow: 2   }
    ...
    // {
    // \n      width: var(--promo-icon-width)     height: var(--promo-icon-height)     background-image: var(--spelling-bee)     background-size: var(--promo-icon-bg-size)     background-position: center     margin-right: 16px     border-radius: var(--promo-icon-border-radius)     padding: var(--promo-icon-padding)   }

    // \n\n    .promo-arrow

    // {
    // \n      width: 7px     height: 11px     justify-self: flex-end   }

    // \n\n    .rule

    // {
    // \n      margin-left: -16px     height: 1px     position: absolute     width: 100%     background-color: var(--color-tone-1)   }

    // \n\n    .countdown

    // {
    // \n      border-right: 1px solid var(--color-tone-1)     padding-right: 12px     width: 50%   }

    // \n\n    .share

    // {
    // \n      display: flex     justify-content: center     align-items: center     padding-left: 12px     width: 50%   }
    ...
    // {
    // \n      background-color: var(--key-bg-correct)     color: var(--key-evaluated-text-color)     font-family: inherit     font-weight: bold     border-radius: 4px     cursor: pointer     border: none     user-select: none     display: flex     justify-content: center     align-items: center     text-transform: uppercase     -webkit-tap-highlight-color: rgba(0,0,0,0.3)     width: 80%     font-size: 20px     height: 52px     -webkit-filter: brightness(100%)   }
    ...
    // {
    // \n      width: 24px     height: 24px     padding-left: 8px   }
          ...
          r(n, [
            {
              ...
              value: function () {
                ...
                if (
                  (a.appendChild(xi.content.cloneNode(!0)),
    ...
    // {
    // \n        list-style: none       color: var(--color-tone-1)       padding: unset       margin: unset   }

    // \n\n    .nyt-list

    // {
    // \n      margin-top: 5px     padding: 12px 0px     border-top: 1px solid #DCDCDC   }

    // \n\n    .nav-item

    // {
    // \n        display: flex       justify-content: left       align-items: center       height: 40px       font-weight: 500       font-family: 'nyt-franklin'       font-size: 16px       line-height: 16px       padding-left: 18px   }
    ...
    // {
    // \n        padding-bottom: 2px       content: ''       height: 20px       width: 28px       padding-right: 8px       display: inline-block       vertical-align: middle       background-repeat: no-repeat   }
    ...
    // {
    // \n        font-family: 'nyt-franklin-700'       font-weight: 700       text-transform: uppercase       font-size: 12px       line-height: 12px       margin: 32px 0px 24px 0px       padding-left: 18px   }
    ...
    // {
    // \n      letter-spacing: .5px     font-family: 'nyt-franklin'     position: absolute     bottom: 0     left: 0     right: 0     margin: 0px 25px 0px 17px     padding: 12px 0px     border-top: 1px solid #DCDCDC     color: var(--color-tone-1)     font-size: 15px     text-align: right     display: flex     justify-content: space-between     align-items: flex-end   }
    ...
    // {
    // \n      display: none     position: absolute     width: 100%     height: 100%     top: 0     left: 0     z-index: ".concat(3e3,'     background-color: transparent     justify-content: left     align-items: unset   }
    ...
    // {
    // \n      position: relative     border: 1px solid var(--color-tone-6)     background-color: var(--modal-content-bg)     color: var(--color-tone-1)     overflow-y: auto     animation: SlideRight 200ms     max-width: var(--game-max-width)     box-sizing: border-box     width: 100%     border-radius: 0px     box-shadow: 3px 5px 5px rgba(0, 0, 0, 0.15)     max-height: calc(100% - var(--header-height) - 1px)     margin-top: calc(var(--header-height) + 1px)     padding: 0px   }
        ...
        r(n, [
          {
            ...
            value: function () {
              var e = this;
              this.shadowRoot.appendChild(Oi.content.cloneNode(!0)),
                this.addEventListener("click", function (t) {
                  e.shadowRoot
    ...
    // (p(HTMLElement));customElements.define("game-nav-modal",Ii);
    ...
    // {
    // \n      height: 20px     width: 32px     vertical-align: middle     /* not quite right */\n      background: var(--color-tone-3)     border-radius: 999px     display: block     position: relative   }

    // \n    .knob

    // {
    // \n      display: block     position: absolute     left: 2px     top: 2px     height: calc(100% - 4px)     width: 50%     border-radius: 8px     background: var(--white)     transform: translateX(0)     transition: transform 0.3s   }
    ...
    // {
    // i(n,e);var t=f(n);function n()

    // {
    // var e;return a(this,n),(e=t.call(this)).attachShadow(
    ...
    // {
    // var e=this;this.shadowRoot.appendChild(Li.content.cloneNode(!0)),this.shadowRoot.querySelector(".container").addEventListener("click",(function(t)
    ...
    // {
    // bubbles:!0,composed:!0,detail:

    // {
    // name:e.getAttribute("name"),checked:e.hasAttribute("checked"),disabled:e.hasAttribute("disabled")}
    ...
    // (p(HTMLElement));customElements.define("game-switch",Ri);

    // var qi=document.createElement("template");
    // qi.innerHTML='\n  <style>\n  .instructions

    // {
    // \n    font-size: 14px   color: var(--color-tone-1)\n  }

    // \n\n  .examples

    // {
    // \n    border-bottom: 1px solid var(--color-tone-4)   border-top: 1px solid var(--color-tone-4) }
    ...
    // (p(HTMLElement));customElements.define("game-help",Ai);
    // var Mi=document.createElement("template");
    // Mi.innerHTML="\n  <style>\n    .overlay

    // {
    // \n      display: none     position: absolute     width: 100%     height: 100%     top: 0     left: 0     justify-content: center     background-color: var(--color-background)     animation: SlideIn 100ms linear     z-index: ".concat(2e3,'   }
    ...
    // {
    // \n      position: relative     color: var(--color-tone-1)     padding: 0 32px     max-width: var(--game-max-width)     width: 100%     overflow-y: auto     height: 100%     display: flex     flex-direction: column   }
    ...
    // {
    // \n      position: absolute     right: 0     user-select: none     cursor: pointer   }
    ...
    // {
    // var e=this;this.shadowRoot.appendChild(Mi.content.cloneNode(!0)),this.shadowRoot.querySelector("game-icon").addEventListener("click",(function(t)
    ...
    // {
    // this.shadowRoot.appendChild(Pi.content.cloneNode(!0));var e=this.getAttribute("icon");this.shadowRoot.querySelector("path").setAttribute("d",Di[e]),"backspace"===e&&this.shadowRoot.querySelector("path").setAttribute("fill","var(--color-tone-1)"),"share"===e&&this.shadowRoot.querySelector("path").setAttribute("fill","var(--white)")}
    ...
    // (p(HTMLElement));customElements.define("nav-icon",$i);var Gi=document.createElement("template");Gi.innerHTML='\n  <div id="timer"></div>\n';var Wi=6e4,Yi=36e5,Vi=function(e)

    // {
    // i(n,e);var t=f(n);function n()

    // {
    // var e;a(this,n),o(h(e=t.call(this)),"targetEpochMS",void 0),o(h(e),"intervalId",void 0),o(h(e),"$timer",void 0),e.attachShadow(

    // {
    // mode:"open"}

    // );var s=new Date;return s.setDate(s.getDate()+1),s.setHours(0,0,0,0),e.targetEpochMS=s.getTime(),e}
    ...
    // {
    // var e,t=(new Date).getTime(),n=Math.floor(this.targetEpochMS-t);if(n<=0)e="00:00:00";else

    // {
    // var a=Math.floor(n%864e5/Yi),s=Math.floor(n%Yi/Wi),r=Math.floor(n%Wi/1e3);e="".concat(this.padDigit(a),":").concat(this.padDigit(s),":").concat(this.padDigit(r))}
    ...
    // {
    // var e=this;this.shadowRoot.appendChild(Gi.content.cloneNode(!0)),this.$timer=this.shadowRoot.querySelector("#timer"),this.intervalId=setInterval((function()
